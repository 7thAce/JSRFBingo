...
Goals:
- [30%] Redo the dashboard. *Everything* in normal operations should be doable from the dashboard. 
- [100%] Convert as much stuff to SVG as possible to control it through JS.
- [100%] Rewrite bingo.js (the display page). It's awful.
- [100%] Centralize everything into a server that fully understands the gamestate and sends out events through websockets.
- [100%] Standings screen.
